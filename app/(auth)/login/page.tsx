      ...
      <div className="p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#B6B6B6]">
            Inicia sesión para acceder a tus reportes de marketing
          </p>
        </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-[#019B77] hover:text-[#02c494] hover:underline"
              >
        ...
        <p className="mt-6 text-center text-sm text-[#B6B6B6]">
          ...
          <Link href="/register" className="text-[#019B77] hover:text-[#02c494] hover:underline font-medium">
            Regístrate gratis
          </Link>
        </p>
      </div>
